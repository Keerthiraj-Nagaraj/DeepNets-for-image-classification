...
split = [2/3, 3/4, 4/5, 5/6] #Number of proceesing elements
...
len_vec = split #this variable is to save time - no need to change variable names
#in results part.... 
