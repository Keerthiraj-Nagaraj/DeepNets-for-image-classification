...
pe = [250, 500, 750, 1000, 1500] #Number of proceesing elements
...
len_vec = pe #this variable is to save time - no need to change variable names
#in results part.... 
...
for i, l in enumerate(pe):
    
    print("running for "+ str(l) + " Processing elements")
    t1 = time.time()
...
#Hidden layer units
h1_arr = np.array(pe).reshape(len(len_vec),1)
